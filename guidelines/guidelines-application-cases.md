...
- [ ] S.8 Any vertices defined through `setMeshVertex` or `setMeshVertices` needs to be real locations in space, i.e. it is not allowed to decode any other information.
